...
export const AppButton: React.FC<AppButtonProps> = ({
  ...
  const textStyle = disabled ? [...getTextStyle(), styles.disabledText] : getTextStyle();

  const buttonStyle = disabled ? [...getButtonStyle(), styles.disabled] : getButtonStyle();
  ...
  return (
    ...
    >
      {loading ? (
        <ActivityIndicator color={variant === "primary" ? "white" : themeColors.tint} size="small" />
      ) : (
